...
/**
 * Honorlock Proctoring disabling page.
 *
...
$pageurl = new moodle_url('/mod/quiz/accessrule/honorlock/status_disable.php');
...
$form = new \quizaccess_honorlock\local\form\disable();
