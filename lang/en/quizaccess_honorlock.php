...
$string['coursenotexist'] = 'Course does not exist';
...
$string['honorlockinactive'] = 'Honorlock is not active';
$string['ltitypedescription'] = 'Honorlock LTI Tool 1.3';
$string['ltitypedescriptioninactive'] = 'Honorlock LTI Tool 1.3 (not active)';
$string['ltitypename'] = 'Honorlock LTI';
...
$string['quiznotexist'] = 'Quiz does not exist';
...
$string['usernotauthenticated'] = 'User not authenticated with Honorlock';
$string['wsroledescription'] = 'Access for API user to the external service';
$string['wsrolename'] = 'Honorlock API Access';
