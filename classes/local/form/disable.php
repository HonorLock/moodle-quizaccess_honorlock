...
class disable extends \moodleform {
    ...
    public function definition() {
        ...
        $info = markdown_to_html(get_string('disableinfo', 'quizaccess_honorlock'));
        $mform->addElement('static', 'info', '', $info);

        $this->add_action_buttons(true, get_string('disable', 'quizaccess_honorlock'));
    }
}
